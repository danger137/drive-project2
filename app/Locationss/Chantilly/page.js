...
<Head>
        <title>YSSR EDUCATION Improvement Program in  Chantilly,  Chantilly | YSSR EDUCATION Academy</title>
        <meta name="description" content="Join our DMV-approved YSSR EDUCATION Improvement Program (DIP) in   Chantilly, Virginia. Earn 5 safe YSSR EDUCATION points, reduce insurance rates, and dismiss traffic tickets." />
        <meta name="keywords" content="YSSR EDUCATION improvement program, DMV points, traffic school, defensive YSSR EDUCATION course,   Chantilly Virginia" />
...
<div style={{ position: "relative", width: "100%", height: "270px" }}>
  <iframe
    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3107.0408502782143!2d-77.443316!3d38.88693!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x89b6442771dec23b%3A0xe15cdb3695e82720!2sHoliday%20Inn%20Chantilly-Dulles%20Expo%20(Arpt),%20an%20IHG%20Hotel!5e0!3m2!1sen!2sus!4v1611139899651!5m2!1sen!2sus"
    width="100%"
    height="270px"
    style={{ border: 0 }}
    allowFullScreen
    loading="lazy"
    title="Google Map - Holiday Inn Chantilly-Dulles Expo"
  ></iframe>
  <a
    href="https://www.google.com/maps/place/Holiday+Inn+Chantilly-Dulles+Expo+(Arpt),+an+IHG+Hotel/@38.88693,-77.443316,16z/data=!4m9!3m8!1s0x89b6442771dec23b:0xe15cdb3695e82720!5m2!4m1!1i2!8m2!3d38.88693!4d-77.443316!16s%2Fg%2F1tf7ym02?hl=tr&entry=ttu&g_ep=EgoyMDI1MDIyNi4xIKXMDSoASAFQAw%3D%3D"
    target="_blank"
...
<div className="flex flex-col lg:flex-row items-center lg:items-start justify-center p-6 lg:p-12 custom-1025 custom-545">
  ...
  <div className="w-full lg:w-auto lg:mr-10">
    <div className="flex flex-wrap justify-center gap-3">
      <img className="w-full sm:w-[620px] h-auto sm:h-[430px]" src="https://aadrivingacademy.net/wp-content/uploads/2022/01/driving-school-classroom-chantilly-virginia.jpg" />
  ...
  <div className="w-full lg:w-auto mt-6 lg:mt-0 lg:mr-36 text-center lg:text-left">
    <div className="p-6">
      ...
      <h1 className="text-3xl sm:text-4xl font-extrabold text-[#0e518f] mt-3">Academy Chantilly</h1>
      <h1 className="text-xl sm:text-2xl font-extrabold text-[#0e518f] mt-2">(DIP only)</h1>
      <p className="text-lg mt-3">Holiday Inn Chantilly-Dulles Expo</p>
      <p className="text-lg mt-1">4335 Chantilly Shopping Center</p>
      <p className="text-lg mt-1">Chantilly, VA 20151</p>
