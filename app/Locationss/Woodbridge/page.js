...
<Head>
        <title>YSSR EDUCATION Improvement Program in Woodbridge,  Woodbridge | YSSR EDUCATION Academy</title>
        <meta name="description" content="Join our DMV-approved YSSR EDUCATION Improvement Program (DIP) in  Woodbridge, Virginia. Earn 5 safe YSSR EDUCATION points, reduce insurance rates, and dismiss traffic tickets." />
        <meta name="keywords" content="YSSR EDUCATION improvement program, DMV points, traffic school, defensive YSSR EDUCATION course,  Woodbridge Virginia" />
...
<div style={{ position: "relative", width: "100%", height: "270px" }}>
  <iframe
    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3102.636676848799!2d-77.287944!3d38.65079!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x89b65675e792dc77%3A0x23c0f6c5197b3cfa!2sCountry+Inn+%26+Suites+by+Radisson,+Potomac+Mills+Woodbridge,+VA!5e0!3m2!1sen!2sus!4v1611139899651!5m2!1sen!2us"
    width="100%"
    height="270px"
    style={{ border: 0 }}
    allowFullScreen
  ...
  ></iframe>
  <a
    href="https://www.google.com/maps/place/Country+Inn+%26+Suites+by+Radisson,+Potomac+Mills+Woodbridge,+VA/@38.65079,-77.287944,14z/data=!4m6!3m5!1s0x89b65675e792dc77:0x23c0f6c5197b3cfa!8m2!3d38.6507904!4d-77.2879436!16s%2Fg%2F1tfm7jt8?hl=en-US&entry=ttu&g_ep=EgoyMDI1MDIyNi4xIKXMDSoASAFQAw%3D%3D"
    target="_blank"
...
<div className="flex flex-col lg:flex-row items-center lg:items-start justify-center p-6 lg:p-12 custom-1025 custom-545">
  ...
  <div className="w-full lg:w-auto lg:mr-10">
    <div className="flex flex-wrap justify-center gap-3">
      <img className="w-full sm:w-[620px] h-auto sm:h-[430px]" src="https://aadrivingacademy.net/wp-content/uploads/2022/01/Country-Inn-WOODBRIDGE.jpg" />
  ...
  <div className="w-full lg:w-auto mt-6 lg:mt-0 lg:mr-36 text-center lg:text-left">
    <div className="p-6">
      ...
      <h1 className="text-3xl sm:text-4xl font-extrabold text-[#0e518f] mt-3">Academy Woodbridge</h1>
      <h1 className="text-xl sm:text-2xl font-extrabold text-[#0e518f] mt-2">(DIP only)</h1>
      <p className="text-lg mt-3">Country Inn & Suites</p>
      <p className="text-lg mt-1">2621 Prince William Parkway</p>
      <p className="text-lg mt-1">Woodbridge, VA 22192</p>
