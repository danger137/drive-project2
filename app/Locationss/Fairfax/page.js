...
<Head>
        <title>YSSR EDUCATION Improvement Program in  Fairfax/Fair Oaks,  Fairfax/Fair Oaks | YSSR EDUCATION Academy</title>
        <meta name="description" content="Join our DMV-approved YSSR EDUCATION Improvement Program (DIP) in  Fairfax/Fair Oaks, Virginia. Earn 5 safe YSSR EDUCATION points, reduce insurance rates, and dismiss traffic tickets." />
        <meta name="keywords" content="YSSR EDUCATION improvement program, DMV points, traffic school, defensive YSSR EDUCATION course,   Fairfax/Fair Oaks Virginia" />
...
<div style={{ position: "relative", width: "100%", height: "270px" }}>
  <iframe
    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3101.8283339255855!2d-77.353529!3d38.863557!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x89b64f26a8b5b7a9%3A0x2fbdc9a2164c9b1f!2s11787%20Lee%20Jackson%20Memorial%20Hwy%2C%20Fairfax%2C%20VA%2022033%2C%20USA!5e0!3m2!1sen!2sus!4v1611139899651!5m2!1sen!2sus"
    width="100%"
    height="270px"
    style={{ border: 0 }}
    allowFullScreen
  ...
  ></iframe>
  <a
    href="https://www.google.com/maps/place/11787+Lee+Jackson+Memorial+Hwy,+Fairfax,+VA+22033/@38.863557,-77.353529,16z/data=!4m6!3m5!1s0x89b64f26a8b5b7a9:0x2fbdc9a2164c9b1f!8m2!3d38.863557!4d-77.353529!16s%2Fg%2F11bw6d0rck?hl=en-US&entry=ttu"
    target="_blank"
...
<div className="flex flex-col lg:flex-row items-center lg:items-start justify-center p-6 lg:p-12 custom-1025 custom-545">
  ...
  <div className="w-full lg:w-auto lg:mr-10">
    <div className="flex flex-wrap justify-center gap-3">
      <img className="w-full sm:w-[620px] h-auto sm:h-[430px]" src="https://aadrivingacademy.net/wp-content/uploads/2022/01/Fairfax-Marriot-FAIR-OAKS-768x512.jpg" />
  ...
  <div className="w-full lg:w-auto mt-6 lg:mt-0 lg:mr-36 text-center lg:text-left">
    <div className="p-6">
      ...
      <h1 className="text-3xl sm:text-4xl font-extrabold text-[#0e518f] mt-3">Academy Fairfax/Fair Oaks</h1>
      <h1 className="text-xl sm:text-2xl font-extrabold text-[#0e518f] mt-2">(DIP only)</h1>
      <p className="text-lg mt-3">Fairfax Marriot at Fair Oaks Mall</p>
      <p className="text-lg mt-1">11787 Lee Jackson Memorial Hwy</p>
      <p className="text-lg mt-1">Fairfax, VA 22033</p>
