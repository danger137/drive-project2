...
<Head>
        <title>YSSR EDUCATION Improvement Program in  Centreville,  Centreville | YSSR EDUCATION Academy</title>
        <meta name="description" content="Join our DMV-approved YSSR EDUCATION Improvement Program (DIP) in   Centreville, Virginia. Earn 5 safe YSSR EDUCATION points, reduce insurance rates, and dismiss traffic tickets." />
        <meta name="keywords" content="YSSR EDUCATION improvement program, DMV points, traffic school, defensive YSSR EDUCATION course,   Centreville Virginia" />
...
<div style={{ position: "relative", width: "100%", height: "270px" }}>
  <iframe
    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3107.913748883435!2d-77.442847!3d38.838866!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x89b63e931313f69d%3A0x2f4b4a58e7b6b165!2s5920%20Trinity%20Pkwy%2C%20Centreville%2C%20VA%2020120%2C%20USA!5e0!3m2!1sen!2sus!4v1611139899651!5m2!1sen!2sus"
    width="100%"
    height="270px"
    style={{ border: 0 }}
    allowFullScreen
  ...
  ></iframe>
  <a
    href="https://www.google.com/maps?ll=38.838866,-77.442847&z=14&t=m&hl=en&gl=US&mapclient=embed&q=5920+Trinity+Pkwy+Centreville,+VA+20120+USA"
    target="_blank"
...
<div className="flex flex-col lg:flex-row items-center lg:items-start justify-center p-6 lg:p-12 custom-1025 custom-545">
  ...
  <div className="w-full lg:w-auto lg:mr-10">
    <div className="flex flex-wrap justify-center gap-3">
      <img className="w-full sm:w-[620px] h-auto sm:h-[430px]" src="https://aadrivingacademy.net/wp-content/uploads/2022/01/Springhill-Suites-CENTREVILLE.jpg" />
  ...
  <div className="w-full lg:w-auto mt-6 lg:mt-0 lg:mr-36 text-center lg:text-left">
    <div className="p-6">
      ...
      <h1 className="text-3xl sm:text-4xl font-extrabold text-[#0e518f] mt-3">Academy Centreville</h1>
      <h1 className="text-xl sm:text-2xl font-extrabold text-[#0e518f] mt-2">(DIP only)</h1>
      <p className="text-lg mt-3">SpringHill Suites Centreville Chantilly</p>
      <p className="text-lg mt-1">5920 Trinity Parkway</p>
      <p className="text-lg mt-1">Centreville, VA 20120</p>
