...
<Head>
        <title>YSSR EDUCATION Improvement Program in  FrontRoyal,  FrontRoyal | YSSR EDUCATION Academy</title>
        <meta name="description" content="Join our DMV-approved YSSR EDUCATION Improvement Program (DIP) in  FrontRoyal, Virginia. Earn 5 safe YSSR EDUCATION points, reduce insurance rates, and dismiss traffic tickets." />
        <meta name="keywords" content="YSSR EDUCATION improvement program, DMV points, traffic school, defensive YSSR EDUCATION course,   FrontRoyal Virginia" />
...
<div style={{ position: "relative", width: "100%", height: "270px" }}>
  <iframe
    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3102.636676848799!2d-78.194797!3d38.960595!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x89b5c40488a2d019%3A0x950071c339e722db!2sHampton%20Inn%20Front%20Royal!5e0!3m2!1sen!2sus!4v1611139899651!5m2!1sen!2sus"
    width="100%"
    height="270px"
    style={{ border: 0 }}
    allowFullScreen
  ...
  ></iframe>
  <a
    href="https://www.google.com/maps/place/Hampton+Inn+Front+Royal/@38.960595,-78.194797,14z/data=!4m9!3m8!1s0x89b5c40488a2d019:0x950071c339e722db!5m2!4m1!1i2!8m2!3d38.9605945!4d-78.1947967!16s%2Fg%2F1tfvj2cn?hl=en-US&entry=ttu"
    target="_blank"
...
<div className="flex flex-col lg:flex-row items-center lg:items-start justify-center p-6 lg:p-12 custom-1025 custom-545">
  ...
  <div className="w-full lg:w-auto lg:mr-10">
    <div className="flex flex-wrap justify-center gap-3">
      <img className="w-full sm:w-[620px] h-auto sm:h-[430px]" src="https://aadrivingacademy.net/wp-content/uploads/2022/01/Hampton-Inn-FRONT-ROYAL.jpg" />
  ...
  <div className="w-full lg:w-auto mt-6 lg:mt-0 lg:mr-36 text-center lg:text-left">
    <div className="p-6">
      ...
      <h1 className="text-3xl sm:text-4xl font-extrabold text-[#0e518f] mt-3">Academy FrontRoyal</h1>
      <h1 className="text-xl sm:text-2xl font-extrabold text-[#0e518f] mt-2">(DIP only)</h1>
      <p className="text-lg mt-3">Hampton Inn</p>
      <p className="text-lg mt-1">9800 Winchester Road</p>
      <p className="text-lg mt-1">Front Royal, VA 22630</p>
