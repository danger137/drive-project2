...
<Head>
        <title>YSSR EDUCATION Improvement Program in  Falls Church,  Falls Church | YSSR EDUCATION Academy</title>
        <meta name="description" content="Join our DMV-approved YSSR EDUCATION Improvement Program (DIP) in  Falls Church, Virginia. Earn 5 safe YSSR EDUCATION points, reduce insurance rates, and dismiss traffic tickets." />
        <meta name="keywords" content="YSSR EDUCATION improvement program, DMV points, traffic school, defensive YSSR EDUCATION course,   Falls Church Virginia" />
...
<div style={{ position: "relative", width: "100%", height: "270px" }}>
  <iframe
    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3101.8283339255855!2d-77.17341!3d38.874037!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x89b7b7407be2e8fd%3A0xa9eb6f2f8cb8a181!2s2855%20Annandale%20Rd%2C%20Falls%20Church%2C%20VA%2022042%2C%20USA!5e0!3m2!1sen!2sus!4v1611139899651!5m2!1sen!2sus"
    width="100%"
    height="270px"
    style={{ border: 0 }}
    allowFullScreen
    loading="lazy"
    title="Google Map - Falls Church"
  ></iframe>
  <a
    href="https://www.google.com/maps/place/2855+Annandale+Rd,+Falls+Church,+VA+22042/@38.874037,-77.17341,14z/data=!4m6!3m5!1s0x89b7b7407be2e8fd:0xa9eb6f2f8cb8a181!8m2!3d38.874037!4d-77.17341!16s%2Fg%2F11b8v6bsvv?hl=en-US&entry=ttu"
    target="_blank"
    ...
    aria-label="Open location in Google Maps - Falls Church"
  ></a>
</div>
...
<div className="flex flex-col lg:flex-row items-center lg:items-start justify-center p-6 lg:p-12 custom-1025 custom-545">
  ...
  <div className="w-full lg:w-auto lg:mr-10">
    <div className="flex flex-wrap justify-center gap-3">
      <img className="w-full sm:w-[620px] h-auto sm:h-[430px]" src="https://aadrivingacademy.net/wp-content/uploads/2022/11/Hampton-Inn-and-Suites-Falls-Church.jpg" />
  ...
  <div className="w-full lg:w-auto mt-6 lg:mt-0 lg:mr-36 text-center lg:text-left">
    <div className="p-6">
      ...
      <h1 className="text-3xl sm:text-4xl font-extrabold text-[#0e518f] mt-3">Academy Falls Church</h1>
      <h1 className="text-xl sm:text-2xl font-extrabold text-[#0e518f] mt-2">(DIP only)</h1>
      <p className="text-lg mt-3">Hampton Inn and Suites Falls Church</p>
      <p className="text-lg mt-1">6430 Arlington Boulevard</p>
      <p className="text-lg mt-1">Falls Church, VA 22042</p>
