...
<Head>
        <title>YSSR EDUCATION Improvement Program in Alexandria, Virginia | YSSR EDUCATION Academy</title>
        <meta name="description" content="Join our DMV-approved YSSR EDUCATION Improvement Program (DIP) in Alexandria, Virginia. Earn 5 safe YSSR EDUCATION points, reduce insurance rates, and dismiss traffic tickets." />
        <meta name="keywords" content="YSSR EDUCATION improvement program, DMV points, traffic school, defensive YSSR EDUCATION course, Alexandria Virginia" />
...
<div style={{ position: "relative", width: "100%", height: "270px" }}>
  <iframe
    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3109.7252234292144!2d-77.0843388!3d38.7383937!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x89b7ae68c724d469%3A0xd40c5a78d6ce773c!2s8100%20Fordson%20Rd%2C%20Alexandria%2C%20VA%2022306%2C%20USA!5e0!3m2!1sen!2sus!4v1611139899651!5m2!1sen!2sus"
    width="100%"
    height="270px"
    style={{ border: 0 }}
    allowFullScreen
  ...
  ></iframe>
  <a
    href="https://www.google.com/maps/place/8100+Fordson+Rd,+Alexandria,+VA+22306/@38.738394,-77.084339,14z/data=!4m6!3m5!1s0x89b7ae68c724d469:0xd40c5a78d6ce773c!8m2!3d38.7383937!4d-77.0843388!16s%2Fg%2F11c4wgj199?hl=en&entry=ttu&g_ep=EgoyMDI1MDIyNi4xIKXMDSoASAFQAw%3D%3D"
    target="_blank"
...
<div className="flex flex-col lg:flex-row items-center lg:items-start justify-center p-6 lg:p-12 custom-1025 custom-545">
  ...
  <div className="w-full lg:w-auto lg:mr-10">
    <div className="flex flex-wrap justify-center gap-3">
      <img className="w-full sm:w-[520px] h-auto sm:h-[430px]" src="https://aadrivingacademy.net/wp-content/uploads/2022/11/Springhill-Suites-Alexandria-768x581.jpeg" />
  ...
  <div className="w-full lg:w-auto mt-6 lg:mt-0 lg:mr-36 text-center lg:text-left">
    <div className="p-6">
      ...
      <h1 className="text-3xl sm:text-4xl font-extrabold text-[#0e518f] mt-3">Academy Alexandria</h1>
      <h1 className="text-xl sm:text-2xl font-extrabold text-[#0e518f] mt-2">(DIP only)</h1>
      <p className="text-lg mt-3">Springhill Suites Alexandria Old Town/Southwest</p>
      <p className="text-lg mt-1">2950 Eisenhower Avenue</p>
      <p className="text-lg mt-1">Alexandria VA 22314</p>
