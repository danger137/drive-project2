...
<div style={{ position: "relative", width: "100%", height: "270px" }}>
  ...
  ></iframe>
  <a
    href="https://www.google.com/maps/place/1043+Sterling+Rd+%23101,+Herndon,+VA+20170/@38.968686,-77.3963,14z/data=!4m6!3m5!1s0x89b6380a2553ebbb:0x54f774babc9ed1e9!8m2!3d38.9686862!4d-77.3963002!16s%2Fg%2F11mbnhlbbg?hl=en&entry=ttu&g_ep=EgoyMDI1MDIxOS4xIKXMDSoASAFQAw%3D%3D"
    target="_blank"
...
<div className="flex flex-col lg:flex-row items-center lg:items-start justify-center p-6 lg:p-12 custom-1025 custom-545">
  ...
  <div className="w-full lg:w-auto lg:mr-10">
    <div className="flex flex-wrap justify-center gap-3">
      <img className="w-full sm:w-[310px] h-auto sm:h-[160px]" src="https://aadrivingacademy.net/wp-content/uploads/2022/01/Herndon-Exterior-June-2018-1024x576.jpg" />
      <img className="w-full sm:w-[310px] h-auto sm:h-[160px]" src="https://aadrivingacademy.net/wp-content/uploads/2022/01/Herndon-Lobby-June-2018-1024x576.jpg" />
    </div>
    <div className="flex flex-col sm:flex-row justify-center gap-2 mt-2">
      <img className="w-full sm:w-[290px] h-auto sm:h-[160px]" src="https://aadrivingacademy.net/wp-content/uploads/2022/01/Herndon-Unit-102a-1024x527.jpg" />
      <img className="w-full sm:w-[166px] h-auto sm:h-[160px]" src="https://aadrivingacademy.net/wp-content/uploads/2022/01/Herndon-1-aa-296x300.jpg" />
      <img className="w-full sm:w-[161px] h-auto sm:h-[160px]" src="https://aadrivingacademy.net/wp-content/uploads/2022/01/Herndon-2-aa-300x225.jpg" />
    </div>
    <div className="flex justify-center mt-2">
      <img className="w-full sm:w-[638px] h-auto sm:h-[100px]" src="https://aadrivingacademy.net/wp-content/uploads/2022/01/Herndon-Unit-102b-1024x148.jpg" />
    </div>
  </div>
  ...
  <div className="w-full lg:w-auto mt-6 lg:mt-0 lg:mr-36 text-center lg:text-left">
    <div className="p-6">
      <h1 className="text-3xl sm:text-4xl font-extrabold text-[#0e518f]">YSSR Academy</h1>
      <h1 className="text-3xl sm:text-4xl font-extrabold text-[#0e518f] mt-3">Herndon</h1>
      <h1 className="text-xl sm:text-2xl font-extrabold text-[#0e518f] mt-2">(Main Office)</h1>
      <p className="text-lg mt-3">1043 Sterling Road #101</p>
      <p className="text-lg mt-1">Herndon, VA 20170</p>
      <p className="text-lg mt-1">Phone #: (703) 478-6800</p>
      <p className="text-lg mt-1">Email: info@Yssrdrivingacademy.net</p>
...
<div className="flex justify-center px-4">
  <div className="w-full max-w-[1129px] text-center lg:text-left lg:mr-28 ">
    <p className="text-base md:text-lg mt-5">
      The 8-hour Driver Improvement Program (DIP) is licensed by the Virginia DMV and the curriculum is the National Safety Council (NSC) Defensive Driving Course, which created the first defensive driving course in 1964 and has been the leader in driver safety training ever since.
    </p>
    <p className="text-base md:text-lg mt-5">
...
<div className="w-full mt-16 flex justify-center">
  <video className="w-full max-w-3xl h-auto" controls src="/Driver Improvement Program 2 (DIP).mp4"></video>
</div>
